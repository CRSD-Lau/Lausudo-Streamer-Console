...
class MainWindow(QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        self.live_tally_dot.setFixedWidth(18)
        self.live_tally_dot.setAlignment(
            Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter
        )
        self.live_tally = QLabel("STANDBY")
        self.live_tally.setObjectName("liveTallyText")
        self.live_tally.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.live_tally_balance = QWidget()
        self.live_tally_balance.setFixedWidth(self.live_tally_dot.width())
        ...
        tally_layout.addStretch(1)
        tally_layout.addWidget(self.live_tally_balance)
